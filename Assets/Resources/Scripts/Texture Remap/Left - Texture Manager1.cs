...
public class VRMaterialCycler_XR0 : MonoBehaviour
{
    [SerializeField] private Material[] materials = new Material[6];
    ...
    {
        var desired = InputDeviceCharacteristics.Left | InputDeviceCharacteristics.Controller;
        var devices = new List<InputDevice>();
        InputDevices.GetDevicesWithCharacteristics(desired, devices);
        ...
        if (devices.Count > 0)
            ...
            Debug.LogWarning("VRMaterialCycler_XR: No left-hand controller found");
    }
